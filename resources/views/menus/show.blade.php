        ...
        <div class="absolute bottom-0 left-0 right-0 p-8">
            <div class="max-w-4xl mx-auto">
                <a href="{{ route('menus.index') }}" 
                   class="inline-flex items-center text-lg font-bold text-black hover:gray-800 mb-4 transition-colors group">
        ...
        <div class="frosted-glass rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="px-8 py-6 bg-gray-50/80 border-t border-gray-200/50 flex justify-end space-x-4">
                <a href="{{ route('menus.edit', $menu->id) }}" 
                    class="text-gray-600 p-3 rounded-full hover:bg-yellow-100 hover:text-yellow-600 transition duration-200 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                </a>
                <button type="button" @click="showDeleteModal = true"
                class="text-gray-600 p-3 rounded-full hover:bg-red-100 hover:text-red-600 transition duration-200 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
