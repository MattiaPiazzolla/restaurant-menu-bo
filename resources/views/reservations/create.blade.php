    ...
    <div class="py-12 bg-gray-50">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl">
                <div class="p-8">
                    <h3 class="text-xl font-semibold text-gray-700 mb-6">Dettagli Prenotazione</h3>
                    ...
                    <form method="POST" action="{{ route('reservations.store') }}">
                        ...
                        <div class="mt-6 space-y-2">
                            ...
                            <input type="text" name="name" id="name" 
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150 ease-in-out" 
                                required value="{{ old('name') }}" placeholder="Inserisci il nome del cliente">
                            @error('name')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div class="space-y-2">
                                ...
                                <input type="number" name="party_size" id="party_size" 
                                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150 ease-in-out" 
                                    required value="{{ old('party_size') }}" min="1" placeholder="Numero di persone">
                                @error('party_size')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="table_number" id="table_number" 
                                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150 ease-in-out" 
                                    required value="{{ old('table_number', '0') }}" min="0" placeholder="Assegna numero tavolo">
                                @error('table_number')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-6 space-y-2">
                            ...
                            <textarea name="note" id="note" 
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150 ease-in-out" 
                                rows="4" placeholder="Richieste speciali o esigenze alimentari">{{ old('note') }}</textarea>
                            @error('note')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
